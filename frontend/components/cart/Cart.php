...
class Cart extends BaseObject
{
    ...
    public function add($product, $quantity)
    {
        ...
        if (isset($this->items[$product->{$this->params['productFieldId']}])) {
            ...
            $this->items[$product->{$this->params['productFieldId']}] = new $this->cartItemClass($product, $quantity, $this->params);
    ...
    {
        $this->loadItems();
        return $this->calculator->getCost($this->items, $withDiscount);
    }
